...
export const mockMeals: MealDetail[] = [
  ...
  },
  {
    id: "2",
    name: "サバの味噌煮",
    description: "こっくり味噌がしみたご飯泥棑な魚料理",
    imageUrl: "",
    cookingTime: "25分",
    tags: ["魚料理", "DHA"],
    ...
    steps: [
      "サバに熱湯をかけて臝みを取り、水気をふく",
      "鍋に酒・水(100ml)・砆糖・薄切り生姜を入れて煮立てる",
  ...
  },
  {
    id: "3",
    name: "谚こまキャベツの回鍋肉風",
    description: "手軽な食材でパパッなｄ作れるピリ辛炒め",
    imageUrl: "",
    cookingTime: "15分",
    tags: ["時短", "野菜たっぷり"],
    ...
    steps: [
      ...
      "谚肉を戻し、甜麺醤・豆板醤・醤油を加えて全体に絡めたら完成",
    ],
    sideDishes: [
      { name: "中華類たまごスープ", description: "ふわふわ卵のやさしいスープ" },
      { name: "きゅうりの浅漬け", description: "さっぱり箸休め" },
    ],
  },
];
